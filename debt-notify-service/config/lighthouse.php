    ...
    */
    ...
    'route' => [
        ...
        'middleware' => [
            ...
            // Validasi Bearer token ke auth-service (account-service tak punya tabel users/sanctum).
            // Mengganti AttemptAuthentication bawaan supaya tidak mencari guard sanctum lokal.
            'remote.auth',
